            ...
            props.cards.map((element, idx)=>(
                <div className='col-4  mt_16' >
                    <div className='col-12 card' style={{backgroundColor : `${element.bgColor}`}}>
                        ...
                        <div className='row'>
                            <div className={props.colorClass ? props.colorClass + ' col-md-9 Heading3' : 'col-md-9 Heading3'}>
                                {element.name}
                            </div>
                            {(props.switch) ? 
                            <div className={props.colorClass ? props.colorClass + ' col-md-3 Heading3 text-right' : 'col-md-3 Heading3 text-right'}>
                                {props.switch}
                            </div>      
                            : "" }
                        </div>
