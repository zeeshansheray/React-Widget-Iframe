...
const useStyles = makeStyles((theme) => ({
  ...
  paper: {
    ...
    overflowY      : 'auto',
    boxShadow      : '0px 0px 0px 1px rgba(29, 28, 29, 0.13), 0px 18px 45px rgba(0, 0, 0, 0.35)',
    borderRadius   : '4px',
    MozUserFocus   : 'none'
  },
}));

export default function CustomsModal({open, component, onClose, minWidth, maxWidth, position, title, onSave, top, left, ...props}) {
